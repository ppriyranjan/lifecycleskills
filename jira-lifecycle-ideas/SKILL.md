...
1. Discover product features launched in the last 2 weeks
...
**If MCP tools are unavailable or return an auth error:** Direct the user to see [JIRA_SETUP.md](JIRA_SETUP.md) for setup instructions. The one-line setup command is:
```
claude mcp add --transport http atlassian https://mcp.atlassian.com/v1/mcp
```
After adding, run `/mcp` in Claude Code to complete OAuth authentication.
