...
function calculateDerivedMetrics(rawMetrics) {
  ...
  return {
    ...
    // Engagement rates (based on delivered, unique metrics preferred)
    open_rate: safePercentage(unique_opens || opened, delivered),
    click_rate: safePercentage(unique_clicks || clicked, delivered),
    click_to_open: safePercentage(unique_clicks || clicked, unique_opens || opened),
    conversion_rate: safePercentage(conversions, delivered),
...
function calculateMetricsComparison(currentMetrics, previousMetrics, dateRanges) {
  ...
  const metricsToCompare = [
    ...
    'unique_opens', 'unique_clicks', 'conversions', 'unsubscribed',
  ...
  // Add total engagement info (no comparison needed for display purposes)
  metrics.engagement_totals = {
